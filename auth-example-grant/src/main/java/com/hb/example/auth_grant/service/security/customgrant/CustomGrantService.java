package com.hb.example.auth_grant.service.security.customgrant;
...
public class CustomGrantService {
    private final UserRepository userRepository;

    public UserDetails loadUserCode(String username) throws UsernameNotFoundException {
        Optional<UserEntity> userOpt = userRepository.findByCode(username);
